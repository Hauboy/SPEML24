...
parser.add_argument('--test_db_path', default='./data', help='the path to the root folder of the training data')
...
parser.add_argument('--model', type=str, required=True, choices=['resnet', 'googlenet'], help='Choose the model to use: resnet or googlenet')
